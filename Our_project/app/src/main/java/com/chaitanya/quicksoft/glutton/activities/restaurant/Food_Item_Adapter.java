...
public class Food_Item_Adapter extends RecyclerView.Adapter<Food_Item_Adapter.Food_item_ViewHolder> implements Filterable {
    ...
    com.chaitanya.quicksoft.glutton.interfaces.food_item_click food_item_click;
    ...
    public Food_Item_Adapter(Context context,List<Food_item_row_model> food_item_row_model_list,food_item_click food_item_click1) {
